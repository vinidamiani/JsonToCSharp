...
namespace DeserializeExtra
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            AtributosDeExtracao atributosDeExtracao =
                JsonSerializer.Deserialize<AtributosDeExtracao>(jsonString);

            Console.WriteLine($"Date: {atributosDeExtracao.NomeAtributo}");
            Console.WriteLine($"TemperatureCelsius: {atributosDeExtracao.OrdemProcessamento}");
            Console.WriteLine($"Summary: {atributosDeExtracao.TipoDoAtributoDeSaida}");
        }
    }
}